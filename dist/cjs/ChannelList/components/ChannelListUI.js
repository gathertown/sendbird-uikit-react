...
var GroupChannelListUIView = require('../../chunks/bundle-CERo_chY.js');
...
var ChannelListUI = function (props) {
    ...
    var _b = useSendbirdStateContext.useSendbirdStateContext(), stores = _b.stores, config = _b.config, eventHandlers = _b.eventHandlers;
