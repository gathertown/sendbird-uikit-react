...
var useLongPress = require('../chunks/bundle-ZbsP2hNa.js');
var LocalizationContext = require('../chunks/bundle-BplSuW2v.js');
var useSendbirdStateContext = require('../useSendbirdStateContext.js');
var Message_context = require('../Message/context.js');
var getIsReactionEnabled = require('../chunks/bundle-Dibky18B.js');
    ...
    return (React.createElement(ui_BottomSheet, { onBackdropClick: hideMenu },
        React.createElement("div", { className: "sendbird-message__bottomsheet" },
            ...
            ((_d = (_c = message.reactions) === null || _c === void 0 ? void 0 : _c.find(function (reaction) { return reaction.key === selectedEmoji; })) === null || _d === void 0 ? void 0 : _d.userIds.map(function (userId) { return members.find(function (member) { return member.userId === userId; }); }).filter(function (member) { return member !== undefined; }))
                .map(function (member) { return (React.createElement(ui_UserListItem, { key: member.userId, className: "sendbird-message__bottomsheet__reactor-list__item", user: member, avatarSize: "36px", onUserAvatarClick: onPressUserProfileCallBack })); })))));
};
...
var EmojiReactions = function (_a) {
    ...
    try {
        ...
        showTheReactedMembers = getIsReactionEnabled.getIsReactionEnabled({
            channel: channel,
            config: config,
        });
    }
    ...
    return (React.createElement("div", { className: index.getClassName([
        ...
        (isMobile && selectedEmojiKey && channel !== null && showTheReactedMembers) && (React.createElement(ReactedMembersBottomSheet, { message: message, channel: channel, emojiKey: selectedEmojiKey, hideMenu: function () {
                setSelectedEmojiKey('');
