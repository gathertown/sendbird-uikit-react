...
var index$1 = require('./bundle-D-432Irw.js');
...
var VoiceRecorderProvider = function (props) {
    ...
    React.useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            Promise.resolve().then(function () { return require('./bundle-DK-xbUlz.js'); }).then(function (data) {
...
//# sourceMappingURL=bundle-CjFSIiUv.js.map
