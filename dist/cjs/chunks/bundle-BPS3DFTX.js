...
var uuid = require('./bundle-aXbXs3dl.js');
require('@sendbird/chat/openChannel');
require('@sendbird/chat/groupChannel');
require('./bundle-BPDG2Sth.js');
var consts = require('./bundle-tCz2WwyT.js');
var useSendbirdStateContext = require('../useSendbirdStateContext.js');
require('./bundle-DLvdMF5T.js');
...
var VoiceRecorderProvider = function (props) {
    ...
    React.useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            Promise.resolve().then(function () { return require('./bundle-DmNYTaoj.js'); }).then(function (data) {
...
//# sourceMappingURL=bundle-BPS3DFTX.js.map
