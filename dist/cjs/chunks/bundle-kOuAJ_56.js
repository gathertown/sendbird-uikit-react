...
var index$1 = require('./bundle-DZTJrxjG.js');
var LocalizationContext = require('./bundle-BeJ7-X59.js');
var useSendbirdStateContext = require('../useSendbirdStateContext.js');
var _const = require('./bundle-ZB7RBE8F.js');
var utils$1 = require('./bundle-CBY-_ev_.js');
var Message_hooks_useDirtyGetMentions = require('../Message/hooks/useDirtyGetMentions.js');
var index = require('./bundle-D-432Irw.js');
var ui_DateSeparator = require('../ui/DateSeparator.js');
var ui_Label = require('./bundle-CkvaXo1D.js');
var ui_MessageInput = require('../ui/MessageInput.js');
var _const$1 = require('./bundle-jIzB_4Er.js');
...
var utils = require('./bundle-DQfemABy.js');
...
var MessageView = function (props) {
    ...
    var _d = utils.deleteNullish(props), renderUserMentionItem = _d.renderUserMentionItem, renderMessage = _d.renderMessage, _e = _d.renderMessageContent, renderMessageContent = _e === void 0 ? function (props) { return React.createElement(ui_MessageContent, _tslib.__assign({}, props)); } : _e, _f = _d.renderSuggestedReplies, renderSuggestedReplies = _f === void 0 ? function (props) { return React.createElement(GroupChannel_components_SuggestedReplies, _tslib.__assign({}, props)); } : _f, renderCustomSeparator = _d.renderCustomSeparator, renderEditInput = _d.renderEditInput, renderFileViewer = _d.renderFileViewer, renderRemoveMessageModal = _d.renderRemoveMessageModal;
    ...
    if (showEdit && ((_b = message === null || message === void 0 ? void 0 : message.isUserMessage) === null || _b === void 0 ? void 0 : _b.call(message))) {
        return ((renderEditInput === null || renderEditInput === void 0 ? void 0 : renderEditInput()) || (React.createElement(React.Fragment, null,
            ...
            React.createElement(ui_MessageInput, { isEdit: true, channel: channel, disabled: editInputDisabled, ref: editMessageInputRef, mentionSelectedUser: selectedUser, isMentionEnabled: groupChannel.enableMention, message: message, onStartTyping: function () {
                    var _a;
...
//# sourceMappingURL=bundle-kOuAJ_56.js.map
