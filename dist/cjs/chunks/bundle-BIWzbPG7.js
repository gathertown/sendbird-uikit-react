...
var index = require('./bundle-DTnbaOzD.js');
require('./bundle-CkvaXo1D.js');
    ...
    return (React.createElement("div", null,
        React.createElement(ui_Modal.Modal, { isFullScreenOnMobile: true, hideFooter: true, onCancel: function () { return onCancel(); }, onSubmit: utils.noop, titleText: stringSet.CHANNEL_SETTING__MEMBERS__SEE_ALL_MEMBERS },
            React.createElement("div", { className: "sendbird-more-members__popup-scroll", onScroll: index.useOnScrollPositionChangeDetector({
                ...
                return (React.createElement(ui_UserListItem, { user: member, key: member.userId, currentUser: currentUserId, action: function (_a) {
                        var parentRef = _a.parentRef, actionRef = _a.actionRef;
                        return (React.createElement(React.Fragment, null, (channel === null || channel === void 0 ? void 0 : channel.myRole) === 'operator' && currentUserId !== member.userId && (React.createElement(ui_ContextMenu.default, { menuTrigger: function (toggleDropdown) { return (React.createElement(ui_IconButton, { className: "sendbird-user-message__more__menu", width: "32px", height: "32px", onClick: function () {
                                    toggleDropdown();
                                } },
                                ...
                                React.createElement(ui_ContextMenu.OperatorMenuItem, { channel: channel, user: member, disable: currentUserId === member.userId, onChange: function (_, member, isOperator) {
                                        setMembers(members.map(function (m) {
                                            if (m.userId === member.userId) {
                                                return _tslib.__assign(_tslib.__assign({}, member), { role: isOperator ? SendbirdChat.Role.OPERATOR : SendbirdChat.Role.NONE });
                                            }
                                            return m;
                                        }));
                                        closeDropdown();
                                ...
                                !(channel === null || channel === void 0 ? void 0 : channel.isBroadcast) && (React.createElement(ui_ContextMenu.MuteMenuItem, { channel: channel, user: member, onChange: function (_, member, isMuted) {
                                        setMembers(members.map(function (m) {
                                            if (m.userId === member.userId) {
                                                return _tslib.__assign(_tslib.__assign({}, member), { isMuted: isMuted });
                                            }
                                            return m;
                                        }));
                                        closeDropdown();
...
//# sourceMappingURL=bundle-BIWzbPG7.js.map
